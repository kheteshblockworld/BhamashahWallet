...
describe('Verifyaadharotp', function() {
    it("Mobilenumber validated Successfully",function(done){
      request(app) 
      api
.post('/verifyaadharotp')
.send({ 
"otp":"111111",
"transaction_id" :"181018017384" ,
"otp_transaction_id":"271657"
})
...
it("fields should not be empty during verify aadharOTP",function(done){
request(app) 
api
.post('/verifyaadharotp')
          .send({  
...
it("Invalid Transaction id",function(done){
    request(app) 
    api
    .post('/verifyaadharotp')
              .send({  
                "otp":"111111",
                "transaction_id" :"181018017546" ,
                "otp_transaction_id":"271657"
                  })
              .set("Accept",'application/json')
              .set('user_language','en')
